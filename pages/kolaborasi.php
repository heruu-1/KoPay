...
<?php include 'navbar.php'; ?>
    ...
    <div class="container">
                <div class="section-header justify-content-center">
                    <h2 class="section-title wow fadeInUp" data-wow-delay=".3s">Kolaborasi</h2>
                    <p class=" wow fadeInUp" data-wow-delay=".4s">KoPay mengundang semua orang atau organisasi untuk bisa berkolaborasi dengan kami</p>
                </div>
                            ...
                            <div class="skills-widget d-flex flex-wrap justify-content-center align-items-center">
                                <div class="skill-item wow fadeInUp" data-wow-delay=".3s">
                                    <div class="skill-inner">
                                        <div class="icon-box">
                                            <img src="../assets/img/icons/oatside.svg" alt="">
                                        </div>
                                ...
                                <div class="skill-item wow fadeInUp" data-wow-delay=".4s">
                                    <div class="skill-inner">
                                        <div class="icon-box">
                                            <img src="../assets/img/icons/Greenfields.svg" alt="">
                                        </div>
                                ...
                                <div class="skill-item wow fadeInUp" data-wow-delay=".5s">
                                    <div class="skill-inner">
                                        <div class="icon-box">
                                            <img src="../assets/img/icons/nestle.svg" alt="">
                                        </div>
                                ...
                                <div class="skill-item wow fadeInUp" data-wow-delay=".6s">
                                    <div class="skill-inner">
                                        <div class="icon-box">
                                            <img src="../assets/img/icons/walls.svg" alt="">
                                        </div>
                                ...
                                <div class="skill-item wow fadeInUp" data-wow-delay=".7s">
                                    <div class="skill-inner">
                                        <div class="icon-box">
                                            <img src="../assets/img/icons/cadbury.svg" alt="">
                                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="section-header text-center">
                                <h3 class="section-title wow fadeInUp" data-wow-delay=".3s">Jadilah Bagian dari kami</h3>
