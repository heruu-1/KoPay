...
<?php include 'navbar.php'; ?>
    ...
    <div class="container">
                <div class="section-header justify-content-center">
                    ...
                    <p class=" wow fadeInUp" data-wow-delay=".4s">Ada pertanyaan atau saran? silahkan menghubungi kami</p>
                </div>
                    ...
                    <div class="col-md-7">
                        <div class="resume-widget">
                            <form>
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlInput2">Alamat Email</label>
                                    <input type="email" class="form-control" id="exampleFormControlInput2" placeholder="nama@example.com">
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlInput3">No. Telepon</label>
                                    <input type="number" class="form-control" id="exampleFormControlInput3" placeholder="Masukkan Nomor Anda">
                                </div>
                                <div class="form-group">
